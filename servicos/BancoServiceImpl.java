...
import interfaces.RepositorioContas; // Importa a interface RepositorioContas
import interfaces.ServicoTransferencias; // Importa a interface ServicoTransferencias

// Implementação dos serviços bancários
public class BancoServiceImpl {
    private RepositorioContas repositorioContas; // Repositório para gerenciar as contas bancárias
    private ServicoTransferencias servicoTransferencias; // Serviço para gerenciar transferências entre contas

    // Construtor que inicializa o repositório de contas e o serviço de transferências
    public BancoServiceImpl(RepositorioContas repositorioContas, ServicoTransferencias servicoTransferencias) {
