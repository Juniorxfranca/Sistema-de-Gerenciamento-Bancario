...
import servicos.ServicoTransferenciasImpl; // Importa a implementação do serviço de transferências
...
public class Main {
    public static void main(String[] args) {
        ...
        RepositorioContas repositorioContas = new RepositorioContasImpl();
        ServicoTransferencias servicoTransferencias = new ServicoTransferenciasImpl(repositorioContas);
